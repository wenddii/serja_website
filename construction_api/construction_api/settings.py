...
SECRET_KEY = 'django-insecure-=mg$iv($vllk6q_^j5@*c%)&8!tp3ox)571&mzj%^*hfh*0nzu'
...
CONTACT_NOTIFICATION_EMAIL = os.environ.get('CONTACT_NOTIFICATION_EMAIL', ADMIN_EMAIL)
